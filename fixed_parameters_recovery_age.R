...
muS[4]<-  1- 0.963 		# mortality rate in adults 15+  (1/yr)
...
b3<- 1 						# chronic/recovered = active
b4<- c(1, 1, 1, 0.8) 			# prop reduction in fecundity if coinfected
b5 <- b1 						# chronic-coinfected = coinfected
...
fixed.params.recov = list(b1= b1, b2 = b2, b3 = b3, b4= b4, b5 = b5, 
	b = b, K = K,
