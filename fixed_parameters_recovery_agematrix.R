...
b[1:3] <- 0						# [1-4)
b[5:14] <- 0.56/2				# uninif age [5-15); raw data (14/25)
b[4] <- max(b[5] * 0.15, 0)		# uninif age [4-5); raw data (2/26)
b[15:20] <- max(b[5] * 0.7/2, 0)# uninif age 15 +; raw data (14/25)
#b <- b/2						# FEMALE calf
# Proportional reductions
b1 <- c(rep(1, 4), rep(0.65, 20-4))		# with bTB (from raw data)
b2 <- c(1, 1, 1, 1, rep(0.68, 20-4))	# with brucellosis
